...
from arqick_artiq_red_mbp_config import ARQICK_DoPulses_Red_Mbp


class ARQICK_red_rabi_mbp_200ps(EnvExperiment, ARQICK_DoPulses_Red_Mbp):
    def build(self):
