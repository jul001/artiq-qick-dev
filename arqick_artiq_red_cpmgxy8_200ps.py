...
class ARQICK_red_CPMGXY8_200ps(EnvExperiment, ARQICK_DoPulses_Red_Mbi):
    def build(self):
        self.setattr_argument("n_cpmg", NumberValue(1, precision=0, step=1))
        self.setattr_argument("pi2_duration_tdds", NumberValue(50, precision=0, step=1))
        ...
        self.setattr_argument("tau_step_tdds", NumberValue(1, precision=0, step=1))
